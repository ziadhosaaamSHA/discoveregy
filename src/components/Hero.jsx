...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Decorative blob */}
      <div
        className={`absolute top-20 ${isRTL ? 'left-0' : 'right-0'} w-[500px] h-[500px] bg-soft rounded-full blur-3xl opacity-60 -z-10`}
        aria-hidden="true"
      />
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className={`flex flex-wrap items-center gap-4 ${isRTL ? 'justify-start' : 'justify-start'}`}>
              <a
                href="#explore"
              ...
              >
                <span className="w-12 h-12 flex items-center justify-center bg-primary rounded-full text-white shadow-btn group-hover:scale-105 transition-transform">
                  <Play size={18} fill="currentColor" className={isRTL ? "rotate-180" : ""} aria-hidden="true" />
                </span>
