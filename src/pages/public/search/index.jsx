...
// SearchResults resolves query params into destination matches for public search.
                ...
                >
                  <Link
                    to={(() => {
                      ...
                      if (role.includes("guide") || role === "tour guide" || role === "tourguide") return `/guide/destination/${dest.id}`;
                      if (role.includes("tourist") || role.includes("tour")) return `/tourist/destination/${dest.id}`;
                      return `/destination/${dest.id}`;
                    })()}
